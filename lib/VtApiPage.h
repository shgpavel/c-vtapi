...
/**
 * @struct VtApiPage
 * @brief A generic filter object that other more specialized handler objects
 * will inherit.
...
/**
 * @brief Common callback for curl library.  Different functions within this
 * libary use this.
 *
 ...
 * @return size_t
 */
size_t __VtApiPage_WriteCb(char *ptr, size_t size, size_t nmemb,
                           void *userdata);
